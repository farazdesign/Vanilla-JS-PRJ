    ...
    return {
        getInput: function () {
            return {
                ...
                //parseFloat takes a string and converts it to a number
        ...
        displayPercentages: function (percentages) {
            ...
            //Callback function for the nodelist
            nodeListForEach(fields, function (current, index) {
...
var controller = (function (budgetCtrl, UICtrl) {
    ...
    var ctrlAddItem = function () {
        ...
        // ensures there are no blanks, non-numbers (NaN), and if the inpute value is greater than 0
